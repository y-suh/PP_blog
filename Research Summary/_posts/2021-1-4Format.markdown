...
**We will also learn how to use CNNs to predict heat flux based on high-speed images**.
...
... which is shown in the screenshot below: ![My helpful screenshot](/assets/images/masks.png)